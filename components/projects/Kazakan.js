...
const MixBot = () => {
    return (
        <Container>
            ...
            <br /><br />
            <Description>My first commerical project, and is project I hold dearest to my heart, as shipping my first commerical game played a pivotal role in making me the developer I am today.<br /><br /> Kazakan was made with C# in Unity, and I did all the artwork in Aseprite. I released Kazakan for mobile, and I wrote an article on Medium about my experience developing it.</Description>
            <br />

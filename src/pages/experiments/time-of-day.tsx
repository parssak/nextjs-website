...
const timesToColors = {
  ...
  afternoon: "from-[#79ADE3] to-[#7B93B9]",
  evening: "from-[#4F7AB0] to-[#79ADE3]",
    ...
    <div className="container pt-24">
      ...
      <div className="h-96 relative overflow-hidden rounded-3xl">
        {Object.entries(timesToColors).map(([t, colors]) => (
          ...
          >
            <div
              className={`font-extrabold duration-500 blur-xl scale-x-150 absolute h-full inset-0 w-full rounded-3xl bg-gradient-to-t transition-all ${colors} 
              ${t === timeOfDay ? "scale-y-125" : "scale-y-105"}`}
            ></div>
